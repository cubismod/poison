...
It's also **tiny** and **privacy conscious** with _no external dependencies_. No JavaScript frameworks, icon packs, or Google fonts. No ads or trackers polluting your console window. **We kept things simple**. A little vanilla JavaScript, a dash of CSS, and the power of Hugo.

All the static assets for the site (JS files, CSS, and fonts) are located within the theme's _/assets/_ directory. **That way you know _exactly_ what's going onto your site**.
...
Provide a floating table of contents for readers with large enough screens (i.e. _screen-width > 1600 pixels_).
...
Even still, _Disqus_ may be the best solution depending on your situation. The above paragraph is only meant to highlight its trade-offs and not meant to discourage its use entirely.
...
Sensibly link and display content into "series" (i.e. _Tutorial One_, _Tutorial Two_, etc.).
...
**Note**: _Enabling KaTeX will add external dependencies._
...
**Note**: _Enabling PlantUML diagrams will add external dependencies._
